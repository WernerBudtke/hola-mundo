...
nuestroTitulo.textContent = 'Probando editar con JS';
console.log(nuestroTitulo.textContent);
...
nuestroTitulo.style.color = 'green';
nuestroTitulo.style.fontSize = '25px';
...
nodoHeader.appendChild(nuevoLogo);
nuevoLogo.src = 'img/woman_bw.jpg';
nuevoLogo.height = '200';
nuevoLogo.width = '200';
setInterval(() => {
    nuestroTitulo.innerText = 'Cuantos Carlitos cocinó Benito: ' + String(Math.random()*1000) + ' carlitos'
}, 2500);
document.querySelector('#entrada-bar')
...
$botonIngreso.onclick = function(){
    ...
    if(edadUsuario >= 18){
        ...
        textoResultado = 'No podes ingresar papa';
    }
    document.querySelector ('#resultado').innerText = textoResultado;
    //nuevoResultado.id = 'resultado';
    //nuevoResultado.fontSize = '100px';
    //document.querySelector('#resultado').innerText = textoResultado;
    return false;
}
