...
//       cosas que te gustan.
    ...
    let comidasFavoritas = ['salchipapa', 'milanesas', 'fugazzeta', 'asado'];
...
// TAREA: Intenta crear un array como una constante y modifica los valores que contiene.
    const bebidasFavoritas = ['coca', 'pepsi', 'fernet'];
    console.log(bebidasFavoritas);
    bebidasFavoritas[2] = 'cerveza';
    console.log(bebidasFavoritas);
...
//       asigna un nuevo array completamente nuevo a la constante
    bebidasFavoritas.push('vino tinto');
    console.log(bebidasFavoritas);
    //bebidasFavoritas = ['vodka', 'daiquiri', 'jugo', 'vino blanco']; tira error
...
//       diez a uno.
    ...
    let numero = 0;
    const NUMERO_FINAL = 10;
    const NUMERO_BUCLES = 10;
    while (numero < NUMERO_BUCLES){
        console.log((NUMERO_FINAL - numero));
        numero = numero + 1;
    }
...
//tarea clase 4
let arrayNumeros = [10, 4, 3, 5, 6, 7, 8, 9, 12, 10];
...
console.log(calcularPromedio(arrayNumeros));